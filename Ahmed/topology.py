...
class Topology:
    ...
    def _load(self):
        ...
        self.graph.add_edge("S5", "S4", port_S5=2, port_S4=3)

        self.graph.add_edge("S1", "S2", port_S1=2, port_S2=1)
        self.graph.add_edge("S2", "S3", port_S2=2, port_S3=1)
        self.graph.add_edge("S3", "S4", port_S3=2, port_S4=2)

        self.graph.add_edge("S4", "H2", port_S4=1, port_H2=1)
        self.graph.add_edge("S1", "H1", port_S1=1, port_H1=1)
